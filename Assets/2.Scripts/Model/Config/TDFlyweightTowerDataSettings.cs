...
{
    private static TDFlyweightTowerDataSettings m_api;
    public static TDFlyweightTowerDataSettings api
        => m_api ??= TDResourceObject.GetResource<TDFlyweightTowerDataSettings>(TDConstant.CONFIG_TOWER);

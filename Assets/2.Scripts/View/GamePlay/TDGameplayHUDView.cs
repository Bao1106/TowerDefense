...
public class TDGameplayHUDView : MonoBehaviour
{
    ...
    private void ShowPausePanel()
    {
        ...
        if (m_PausePanelCG != null)
        {
            ...
            m_PausePanelCG.DOFade(1f, TDConstant.HUD_PAUSE_FADE_IN).SetEase(Ease.OutCubic)
    ...
    private void HidePausePanel()
    {
        ...
        if (m_PausePanelCG != null)
        {
            m_PausePanelCG.interactable = false;
            m_PausePanelCG.blocksRaycasts = false;
            m_PausePanelCG.DOFade(0f, TDConstant.HUD_PAUSE_FADE_OUT).SetEase(Ease.InCubic)
                .SetTarget(m_PausePanel).SetUpdate(true)
    ...
    private void PlaySceneFadeIn()
    {
        ...
        m_TransitionOverlay.DOFade(0f, TDConstant.HUD_SCENE_FADE_IN).SetEase(Ease.OutCubic).SetUpdate(true)
    ...
    private void PlaySceneFadeOut(Action onComplete)
    {
        ...
        m_TransitionOverlay.DOFade(1f, TDConstant.HUD_SCENE_FADE_OUT).SetEase(Ease.InCubic).SetUpdate(true)
            .SetTarget(m_TransitionOverlay)

...
namespace BuildReportTool
{
    public static class UnityBuildSettingsUtility
    {
        ...
        public static GUIContent[] GetBuildSettingsCategoryListForDropdownBox()
        {
            ...
            {
                /* 0 */ new GUIContent("Windows"), /* 1 */ new GUIContent("Mac"), /* 2 */ new GUIContent("Linux"), /* 3 */ new GUIContent("Web"), /*  4 */ new GUIContent("Web GL"), /*  5 */ new GUIContent("iOS"), /*  6 */ new GUIContent("Android"), /*  7 */ new GUIContent("Blackberry"), /*  8 */ new GUIContent("Xbox 360"), /*  9 */ new GUIContent("Xbox One"), /* 10 */ new GUIContent("Playstation 3"), /* 11 */ new GUIContent("Playstation 4"), /* 12 */ new GUIContent("Playstation Vita (Native)"), /* 13 */ new GUIContent("Samsung TV"),
            };
        }
		...
		settings.StripPhysicsCode = PlayerSettings.stripPhysics;
            ...
            settings.StrippingLevelUsed = ""; //TODO: obsolete
...
#if !UNITY_5_1_AND_LESSER
            settings.EnableVirtualRealitySupport = false; //TODO: obsolete
#endif
        ...
        public static void PopulateStandaloneSettings(UnityBuildSettings settings)
        {
            ...
            // ---------------------------------------------------------------
            settings.StandaloneResolutionDialogSettingUsed = "";    //TODO: obsolete
		...
		settings.StandaloneFullScreenByDefault = PlayerSettings.fullScreenMode == FullScreenMode.FullScreenWindow || PlayerSettings.fullScreenMode == FullScreenMode.ExclusiveFullScreen;
#endif
#if !UNITY_5_2_AND_LESSER
		...
		settings.WinDirect3D11FullscreenModeUsed = ""; //TODO: obsolete
#endif
...
#if UNITY_2017_AND_LESSER
		settings.MacFullscreenModeUsed = ""; //TODO: obsolete
#endif
        }

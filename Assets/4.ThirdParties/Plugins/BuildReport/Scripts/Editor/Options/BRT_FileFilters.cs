...
namespace BuildReportTool
{
    ...
    public class FileFilters
    {
        ...
        private Dictionary<string, bool> _filtersDict = new Dictionary<string, bool>();

        [SerializeField]
        private string[] _filtersList;

        [SerializeField]
        private bool _usesFolderFilter = false;

        [SerializeField]
        private bool _usesExactFileMatching = false;
    ...
    {
        [SerializeField]
        private FileFilters[] _fileFilters;
        ...
        private int _selectedFilterIdx = 0;
        public int SelectedFilterIdx => _selectedFilterIdx - 1;
        ...
        private string GetStyleToUse(int assetNum, int selectedIdx, int idxOfThisGroup)
        {
            string styleToUse;
        ...
        private void DrawFiltersAsDropDown(AssetList assetList, float width)
        {
            GUILayout.BeginHorizontal();
            GUILayout.Space(3);
            GUILayout.Label("Filter: ", Window.Settings.TOP_BAR_LABEL_STYLE_NAME);
            if (assetList != null && assetList.Labels != null && assetList.Labels.Length > 0)
            {
                _selectedFilterIdx = EditorGUILayout.Popup(_selectedFilterIdx, assetList.Labels, Window.Settings.FILE_FILTER_POPUP_STYLE_NAME);
            }
            GUILayout.EndHorizontal();
        }

        private void DrawFiltersAsButtons(AssetList assetList, float width)
        {
            string styleToUse;
        ...
        public FileFilters this[int idx] => _fileFilters[idx];

        public int Count => _fileFilters.Length;

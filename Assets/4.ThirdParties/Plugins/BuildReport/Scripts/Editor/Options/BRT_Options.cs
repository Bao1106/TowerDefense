...
namespace BuildReportTool
{
    ...
    public static class Options
    {
        ...
        private static string DefaultOptionsPath => string.Format("{0}/BuildReport/{1}", Application.dataPath, SAVED_OPTIONS_FILENAME);

        private static bool IsBuildReportInRegularPaths => Directory.Exists(string.Format("{0}/BuildReport", Application.dataPath)) || Directory.Exists(string.Format("{0}/Plugins/BuildReport", Application.dataPath));
        ...
        private static void InitializeOptionsIfNeeded()
        {
            ...
            if (string.IsNullOrEmpty(_foundPathForSavedOptions))
            {
                ...
                string optionsInBuildReportFolder = DefaultOptionsPath;
                ...
                string optionsInPluginsBuildReport = string.Format("{0}/Plugins/BuildReport/{1}", Application.dataPath, SAVED_OPTIONS_FILENAME);
                ...
                {
                    string customBuildReportFolder = Util.FindAssetFolder(Application.dataPath, BUILD_REPORT_TOOL_DEFAULT_FOLDER_NAME);
                    if (!string.IsNullOrEmpty(customBuildReportFolder))
                    {
                        string optionsInCustomBuildReportFolder = string.Format("{0}/{1}", customBuildReportFolder, SAVED_OPTIONS_FILENAME);
                ...
                // ---------------------------------------------------
                // look in /Assets/
                string optionsInTopmostAssets = string.Format("{0}/{1}", Application.dataPath, SAVED_OPTIONS_FILENAME);
                ...
                string outsideAssets = Util.GetProjectPath(Application.dataPath);
                string optionsOutsideAssets = string.Format("{0}{1}", outsideAssets, SAVED_OPTIONS_FILENAME);
                ...
                string optionsInProjectSettings = string.Format("{0}ProjectSettings/{1}", outsideAssets, SAVED_OPTIONS_FILENAME);
                ...
                string optionsInMyDocs = string.Format("{0}/{1}/{2}", Util.GetUserHomeFolder(), BUILD_REPORTS_DEFAULT_FOLDER_NAME, SAVED_OPTIONS_FILENAME);
            ...
            if (_savedOptions == null)
            {
                ...
                string defaultFolder = Path.GetDirectoryName(_foundPathForSavedOptions);
        ...
        public static string BuildReportSavePath
        {
            get
            {
                ...
                {
                    return Util.GetUserHomeFolder() + "/" + BuildReportFolderName;
                }
                else
                {
                    // assume BuildReportTool.Options.SaveType == BuildReportTool.Options.SAVE_TYPE_PROJECT

                    return ReportGenerator.GetSavePathToProjectFolder() + "/" + BuildReportFolderName;
                }
            }
        }
        ...
        public static bool IsCurrentCalculationLevelAtFull => IsCalculationLevelAtFull(IncludeUsedAssetsInReportCreation, IncludeUnusedAssetsInReportCreation, IncludeUnusedPrefabsInReportCreation);

        public static bool IsCurrentCalculationLevelAtNoUnusedPrefabs => IsCalculationLevelAtNoUnusedPrefabs(IncludeUsedAssetsInReportCreation, IncludeUnusedAssetsInReportCreation, IncludeUnusedPrefabsInReportCreation);

        public static bool IsCurrentCalculationLevelAtNoUnusedAssets => IsCalculationLevelAtNoUnusedAssets(IncludeUsedAssetsInReportCreation, IncludeUnusedAssetsInReportCreation, IncludeUnusedPrefabsInReportCreation);

        public static bool IsCurrentCalculationLevelAtOverviewOnly => IsCalculationLevelAtOverviewOnly(IncludeUsedAssetsInReportCreation, IncludeUnusedAssetsInReportCreation, IncludeUnusedPrefabsInReportCreation);

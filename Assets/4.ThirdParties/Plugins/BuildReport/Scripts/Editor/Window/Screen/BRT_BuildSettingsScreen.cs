...
namespace BuildReportTool.Window.Screen
{
    public class BuildSettings : BaseScreen
    {
        ...
        private bool IsShowingWebPlayerSettings => _settingsShown == BuildSettingCategory.WebPlayer;

        private bool IsShowingWebGlSettings => _settingsShown == BuildSettingCategory.WebGL;

        // ----------------------------------------------

        private bool IsShowingStandaloneSettings => IsShowingWindowsDesktopSettings || IsShowingMacSettings || IsShowingLinuxSettings;

        private bool IsShowingWindowsDesktopSettings => _settingsShown == BuildSettingCategory.WindowsDesktopStandalone;

        private bool IsShowingWindowsStoreAppSettings => _settingsShown == BuildSettingCategory.WindowsStoreApp;

        private bool IsShowingMacSettings => _settingsShown == BuildSettingCategory.MacStandalone;

        private bool IsShowingLinuxSettings => _settingsShown == BuildSettingCategory.LinuxStandalone;

        // ----------------------------------------------

        private bool IsShowingMobileSettings => IsShowingiOSSettings || IsShowingAndroidSettings || IsShowingBlackberrySettings;

        private bool IsShowingiOSSettings => _settingsShown == BuildSettingCategory.iOS;

        private bool IsShowingAndroidSettings => _settingsShown == BuildSettingCategory.Android;

        private bool IsShowingBlackberrySettings => _settingsShown == BuildSettingCategory.Blackberry;

        // ----------------------------------------------

        private bool IsShowingXbox360Settings => _settingsShown == BuildSettingCategory.Xbox360;

        private bool IsShowingXboxOneSettings => _settingsShown == BuildSettingCategory.XboxOne;

        private bool IsShowingPS3Settings => _settingsShown == BuildSettingCategory.PS3;

        private bool IsShowingPS4Settings => _settingsShown == BuildSettingCategory.PS4;

        private bool IsShowingPSVitaSettings => _settingsShown == BuildSettingCategory.PSVita;

        // ----------------------------------------------

        private bool IsShowingSamsungTvSettings => _settingsShown == BuildSettingCategory.SamsungTV;

        // =================================================================================

        private int _selectedSettingsIdxFromDropdownBox = 0;
        ...
        private void DrawBuildSettings(BuildInfo buildReportToDisplay, UnityBuildSettings settings)
        {
        ...
        private void DrawDebugSettings(BuildInfo buildReportToDisplay, UnityBuildSettings settings)
        {
        ...
        private void DrawGraphicsSettings(BuildInfo buildReportToDisplay, UnityBuildSettings settings)
        {

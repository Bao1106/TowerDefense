...
namespace BuildReportTool
{
    ...
    public class BuildInfo
    {
        ...
        private TimeSpan _reportGenerationTime;
        ...
        private long GetSizeSumForUsedAssets(string assetFolderName, Func<string, bool> fileTypePredicate)
        {
            ...
            return UsedAssets.All.Where(part => Util.IsFileInAPath(part.Name, assetFolderName) && fileTypePredicate(part.Name)).Sum(part => BRT_LibCacheUtil.GetImportedFileSize(part.Name));
        }
        ...
        public bool HasOldSizeValues => string.IsNullOrEmpty(UnusedTotalSize) && string.IsNullOrEmpty(UsedTotalSize) && string.IsNullOrEmpty(StreamingAssetsSize) && string.IsNullOrEmpty(WebFileBuildSize) && string.IsNullOrEmpty(AndroidApkFileBuildSize) && string.IsNullOrEmpty(AndroidObbFileBuildSize);
        ...
        public bool HasStreamingAssets => StreamingAssetsSize != "0 B";
        ...
        public bool HasUsedAssets => UsedAssets != null;

        public bool HasUnusedAssets => UnusedAssets != null;
        ...
        private int _unusedAssetsBatchNum = 0;

        public int UnusedAssetsBatchNum => _unusedAssetsBatchNum;
        ...
        public BuildTarget BuildTargetUsed => _buildTarget;
        ...
        public bool RequestedToRefresh => _refreshRequest;


        // Queries
        // ==================================================================================

        public bool HasContents => !string.IsNullOrEmpty(ProjectName) && BuildSizes != null && BuildSizes.Length > 0;
        ...
        public void RecategorizeAssetLists()
        {
            ...
            if (UsedAssets != null)
            {
                UsedAssets.AssignPerCategoryList(ReportGenerator.SegregateAssetSizesPerCategory(UsedAssets.All, fileFiltersToUse));
            ...
            if (UnusedAssets != null)
            {
                UnusedAssets.AssignPerCategoryList(ReportGenerator.SegregateAssetSizesPerCategory(UnusedAssets.All, fileFiltersToUse));
